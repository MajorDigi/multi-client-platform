...
14. The header Status field, the Phase Status table, the Last Updated date, and the README Build Status table must always be updated together in the same commit. They are never updated separately. When a phase completes or a significant change is made PM updates all four in one Claude Code command.
